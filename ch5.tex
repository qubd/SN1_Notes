...
\begin{example}
Sam has two coins. One is fair, and the other has tails on both sides. He selects one of the coins, then flips it five times. Compute the probability of each type of error when testing $H_0: p = \frac{1}{2}$ against $H_a: p = 1$ at the 5\% significance level, where $p$ denotes the probability of tails on the coin.
