...
\begin{remark}
It will be extremely important to distinguish the mean of a population from the mean of a random sample taken from a population. For this reason, the greek letter $\mu$ is used for the mean of a population (a parameter), while $\littlexbar$ is used for the mean of a sample (a statistic). Typically, parameters are denoted by greek letters.
\end{remark}
